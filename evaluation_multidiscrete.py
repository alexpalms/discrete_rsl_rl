...
if __name__ == "__main__":
    ...
    plt.plot(risk_chart["top_k_failure_probability"], label="Top K Failure Probability Maintenance (K=10)", color='green', marker='o')
    plt.plot(risk_chart["top_k_score"], label="Top K Score Maintenance (K=10)", color='red', marker='*')
    plt.plot(risk_chart["top_k_risk"], label="Top K Risk Maintenance (K=10)", color='blue', marker='*')
    ...
    plt.ylabel('Failure Risk', fontsize=14)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    plt.legend(loc='upper left', fontsize=12)
    plt.title('Failure Risk Over Time', fontsize=16)
    plt.show(block=True)
    pass